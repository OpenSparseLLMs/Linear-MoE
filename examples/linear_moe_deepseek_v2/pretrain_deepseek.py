...
from linear_moe.model.deepseek_v2.layer_specs import (
...
from linear_moe.model.deepseek_v2.model import GPTModel
from linear_moe.model.deepseek_v2.hybrid.hybrid_model import HybridGPTModel
from linear_moe.sequence_modeling.mamba2.mamba_model import MambaModel
from linear_moe.model.deepseek_v2.transformer_config import DeepSeekV2TransformerConfig
...
def model_provider(pre_process=True, post_process=True) -> Union[GPTModel, MambaModel, megatron.legacy.model.GPTModel]:
    ...
    if args.sequence_modeling_type != "attention":
        if args.sequence_modeling_module == "mamba2":
            ...
            hybrid_transformer_layer_spec = get_hybrid_based_linear_moe_layer_local_spec(args.num_experts, args.moe_grouped_gemm, qk_layernorm=True)
        elif args.sequence_modeling_module == "rebased":
            hybrid_transformer_layer_spec = get_hybrid_rebased_linear_moe_layer_local_spec(args.num_experts, args.moe_grouped_gemm, qk_layernorm=True)
        elif args.sequence_modeling_module == "linear_attention":
            hybrid_transformer_layer_spec = get_hybrid_basic_linear_attention_linear_moe_layer_local_spec(args.num_experts, args.moe_grouped_gemm, qk_layernorm=True)
